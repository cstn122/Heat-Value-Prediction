...
"""
Reference:
https://github.com/castaned/CNN_gpu/blob/main/weather_prediction.ipynb
"""
...
#import data
file = "5min_lhv_time_dataReport_1st_1101010-1101016_noBlank.csv"
dataset = pd.read_csv(file)
print(dataset)
if filter_on == 1:
  dataset['LHV1'] = medfilt(dataset['LHV1'], 3)
  dataset['LHV1'] = gaussian_filter1d(dataset['LHV1'], 1.2)
...
plt.subplot(3, 1, 1)
plt.plot(dataset['LHV1'], color = 'black', linewidth=1, label = 'True value')
